    ...
    <div class="">
            ...
            <el-row :gutter="40">
              <el-col :md="10">
                <el-form-item label="凭证号">
                  <el-input style="width: 80%;" v-model="form.pzh" placeholder="请输入凭证号"/>
                </el-form-item>
              </el-col>
              <el-col :md="9">
                <el-form-item label="状态">
                  <el-select style="z-index: 2555;" v-model="form.status" clearable placeholder="请选择">
                    <el-option
                    style="z-index: 2555;"
        ...
        <!-- <div class="mainLisy">
            <div class="mainListItem" v-for="item in getResolveData">
                ...
                <div class="itemlaner">{{item.finStatus}}</div>
            </div> -->
            <template>
              <el-table
              :data="getResolveData"
    ...
    methods:{
        getListData(){
            let params={
                ...
                m:{
                    credentialCode:this.form.pzh,
                    finStatus:this.form.status
                }
            }
            mapGuide.getWtzsListData(params).then(res=>{
