<template>
    <div class="">
        <el-form>
            <el-row :gutter="20">
              <el-col :md="6">
                <el-form-item label="品名代码">
                    <el-input style="width: 60%;" v-model="form.pmdm" placeholder="请输入品名代码"/>
                </el-form-item>
              </el-col>
              <el-col :md="6">
            ...
            <el-row :gutter="20">
                <el-col :md="6">
                    <el-form-item label="号型系列">
                        <el-input style="width: 60%;" v-model="form.hxxl" placeholder="请输入号型系列"/>
                    </el-form-item>
                  </el-col>
                  <el-col :md="6">
                    <el-form-item label="号型" label-width="87px">
                        <el-input style="width: 85%;" v-model="form.hx" placeholder="请输入号型"/>
                    </el-form-item>
                  </el-col>
                  <el-col :md="3">
        ...
        <!-- <div class="mainLisy">
            <div class="mainListItem" v-for="item in getResolveData">
                <div class="itemlaner" :title="item.baseCode">{{item.baseCode}}</div>
                ...
                <div class="itemlaner">{{item.ycsl}}</div>
            </div> -->
            <template>
                <el-table
                :data="getResolveData"
        ...
        getListData(){
            let params={
                ...
                m:{
                    ...
                    pmCode:this.form.pmdm,
                    pm:this.form.wzpm,
                    hxxl:this.form.hxxl,
                    hx:this.form.hx,
                }
            }
            mapGuide.getCkjkListData(params).then(res=>{
