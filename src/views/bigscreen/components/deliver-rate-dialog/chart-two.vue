...
export default {
    ...
    methods: {
        fetchDatas() {
            HomeAPI.fetchTopTimelyDeliveryRate({ params: { type: 'week' }}).then(res => {
                ...
                series: [
                        ...
                        itemStyle: {
                            normal: {
                                color: {
                                    ...
                                    {
                                        offset: 0,
                                        color: 'rgba(51, 96, 136, 0.7)', // 0% 处的颜色
                                    },
                                    {
                                        offset: 0.7,
                                        color: 'rgba(51, 96, 136, 0.1)', // 100% 处的颜色
                                    },
                                    {
                                        offset: 1,
                                        color: 'rgba(51, 96, 136, 0)', // 100% 处的颜色
                                    },
                                    ],
                    ...
                    },
                    {
                        ...
                        lineStyle: {
                            normal: {
                                width: 2,
                                color: "rgba(8, 183, 203, 1)", // 线条颜色
                            },
                            borderColor: 'rgba(0,0,0,.4)',
                        },
                        itemStyle: {
                            color: "#b7f9ff",
                            borderColor: "rgba(78, 145, 201, 1)",
                            borderWidth: 2,
