        ...
        <el-form style="height: 30px;">
            <el-row :gutter="40">
              ...
              <el-col :md="3" style="display:flex">
                ...
                <div class="btnSty" style="margin-left:10px" @click="toBefo">返回</div>
              </el-col>
            </el-row>
          </el-form>
        <div class="" style="">
            <!-- <div class="titlehead">
                ...
                <div class="itemlaner">派件省份</div>
                <div class="itemlaner">包裹数量(件)</div>
                <div class="itemlaner">包裹体积(m3)</div>
                <div class="itemlaner">包裹重量(kg)</div>
                <div class="itemlaner">运输方式</div>
                <div class="itemlaner">运输状态</div>
            </div>
            <div class="mainLisy">
                <div class="mainListItem" v-for="item in contData">
                    <div class="itemlaner" style="color: #27cbff;" @click="showDetail(item)">{{item.waybillNo}}</div>
...
.el-table__body tr.hover-row>td.el-table__cell{
  ...
  .el-table__body tr.hover-row>td.el-table__cell:first-child{
   ...
   border-top: 0.5px solid #01ffff !important;
  }
