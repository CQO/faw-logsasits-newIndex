<template>
    <div class="water-eval-container">
        ...
        <div class="echartsRight">
            <div class="righgtLef">
                <div>
                    <img src="../../../../../assets/image/homePage/newer/hyzsEchartOne.png" alt="">
                </div>
                <div class="yc">
                    <div>空运</div>
                    <div style="color:#0098F3">36%</div>
                </div>
            </div>
            <div class="righgtLef" style="margin-top:10px">
                <div>
                    <img src="../../../../../assets/image/homePage/newer/hyzsEchartTwo.png"></img>
                </div>
                <div class="yc">
                    <div>陆运</div>
                    <div style="color:#52FFD2">36%</div>
                </div>
            </div>
         </div>
    </div>
...
.buttomCharts{
  background: center top url('/src/assets/image/homePage/newer/hyzsDp.png') no-repeat;
