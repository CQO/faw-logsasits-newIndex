    ...
    <div class="">
        ...
        <el-form label-width="120px" style="margin-right: 20px">
            <el-row :gutter="40">
              <el-col :md="10">
                <el-form-item label="机构编码">
                  <el-input v-model="formWltsfxValue.jgbm" style="width: 70%;" placeholder="请输入订单号"/>
                </el-form-item>
              </el-col>
              <el-col :md="10">
                <el-form-item label="仓储中心名称">
                    <el-input v-model="formWltsfxValue.cczxmc" style="width: 70%;" placeholder="请输入订单号"/>
                  </el-form-item>
              </el-col>
              <el-col :md="3">
            ...
            <div class="titlehead">
                    ...
                    <div class="cbycitemlaner">实际库存余量</div>
                    </div>
            </div>
            <div class="mainLisy">
                <div class="mainListItem" v-for="item in getWltsfxData">
                    ...
                    <div class="cbycitemlaner contentOver" :title="item.hx">{{item.hx}}</div>
                    <div class="cbycitemlaner">{{item.surplus}}</div>
                </div>
                <el-pagination
                class="pageAtion"
  background
...
getWltsfxList(){
    let params={
        ...
        m:{
            baseCode:this.formWltsfxValue.jgbm,
            name:this.formWltsfxValue.cczxmc
        }
      }
    getPlanMonitorDataApi.getCcjkListData(params).then(res=>{
