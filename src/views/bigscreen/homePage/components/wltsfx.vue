        ...
        <el-form label-width="120px" style="margin-right: 20px">
            <el-row :gutter="40">
              <el-col :md="10">
                <el-form-item label="运单状态">
                  <el-select style="z-index: 3000;" clearable placeholder="请选择" v-model="formWltsfxValue.jsStatus" @change="currWorkTypeChange">
                    <el-option
              ...
              <el-col :md="10">
                <el-form-item label="运输方式">
                  <el-select style="z-index: 3000;" clearable placeholder="请选择" v-model="formWltsfxValue.transportWork" @change="currWorkTypeChange">
                    <el-option
            ...
            <div class="mainLisy">
                <div class="mainListItem" v-for="item in getWltsfxData">
                    ...
                    <div class="cbycitemlaner contentOver" :title="item.waybillStatus">{{item.waybillStatus}}</div>
                </div>
                <el-pagination
                class="pageAtion"
  background
...
getWltsfxList(){
    let params={
        ...
        m:{
            waybillStatus:this.formWltsfxValue.jsStatus,
            transportType:this.formWltsfxValue.transportWork
        }
      }
    getPlanMonitorDataApi.getWltsfxListData(params).then(res=>{
