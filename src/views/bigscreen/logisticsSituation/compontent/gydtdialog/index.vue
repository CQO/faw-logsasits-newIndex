    ...
    <div class="">
        ...
        <!-- <div class="titlehead">
            <div class="mainListItem" style=" margin-left: 1px; flex: 1; display: flex;">
                ...
                <div class="itemlaner">接收单位</div>
                <div class="itemlaner">期限</div>
                <div class="itemlaner">品名代码</div>
                <div class="itemlaner">品名</div>
                <div class="itemlaner">号型数</div>

            </div>
        </div> -->
        <!-- <div class="mainLisy">
            <div class="mainListItem" v-for="item in getResolveData">
                <div class="itemlaner" :title="item.recipientUnit">{{item.recipientUnit}}</div>
                <div class="itemlaner" :title="item.sendFromUnit">{{item.sendFromUnit}}</div>
                <div class="itemlaner">{{item.receiveUnit}}</div>
                <div class="itemlaner contentOver" :title="item.deadLine">{{item.deadLine}}</div>
                <div class="itemlaner">{{item.materialCode}}</div>
                <div class="itemlaner">{{item.material}}</div>
                <div class="itemlaner">{{item.styleNum}}</div>
            </div> -->
           <template>
            <el-table
            :data="getResolveData"
...
wzpm:'',
    ...
    methods:{
        getListData(){
            ...
            logisticsSituationApi.getGydtData(params).then(res=>{
