<template>
    <div class="wave-echart" id='waveTlEchart' ref='waveEchart' style="width:140px;height:140px" ></div>
</template>
<script>
...
this.tlData = res.m.railwayRate/100;
let chart = echarts.init(document.getElementById("waveTlEchart"));
// 把配置和数据放这里
let option={
  title: {// 标题
    // text: '补贴资金剩余',
