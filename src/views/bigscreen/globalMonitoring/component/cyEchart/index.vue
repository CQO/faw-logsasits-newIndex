<template>
    <div class="wave-echart" id='waveCyEchart' ref='waveCyEchart' style="width:140px;height:140px" ></div>
</template>
<script>
...
this.cyData = res.m.shipRate/100;
let chart = echarts.init(document.getElementById("waveCyEchart"));
// 把配置和数据放这里
let option={
  title: {// 标题
    // text: '补贴资金剩余',
