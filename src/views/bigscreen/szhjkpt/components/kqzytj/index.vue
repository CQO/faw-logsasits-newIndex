<template>
    <div style="margin: 2px 30px;">
        <div class="headTitle">
            <div class="headData">
                <!-- <div>{{ item.name }}</div> -->
                <div class="headItem">待作业任务数</div>
                <div class="headItem">库区</div>
                <div class="headItem">待入库任务</div>
                <div class="headItem">待入库量(万件)</div>
                <div class="headItem">待出库任务</div>
                <div class="headItem">待出库量(件)</div>
                <div class="headItem">总任务</div>
                <div class="headItem">总数量(件)</div>
            </div>
        </div>
        <div class="contMain">
