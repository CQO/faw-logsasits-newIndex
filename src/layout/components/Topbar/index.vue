...
export default {
    ...
    computed: {
        breadcrumbList() {
            ...
            if (breadcrumbList && breadcrumbList.length && breadcrumbList[breadcrumbList.length - 1].path === '/organization/apply/exec/:id') {
                breadcrumbList.splice(breadcrumbList.length - 1, 0, {path: '/organization/apply/list', title: '资料申报', i18n: undefined})
            }
